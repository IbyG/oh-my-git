...
if [ -n "${BASH_VERSION}" ]; then
    ...
    : ${omg_needs_to_merge_symbol:='NTM'}
    : ${omg_detached_symbol:='D'}
    : ${omg_can_fast_forward_symbol:='CFF'}
    : ${omg_has_diverged_symbol:='Div'}
    : ${omg_not_tracked_branch_symbol:='NTB'}
    : ${omg_rebase_tracking_branch_symbol:='RT'}     
    : ${omg_merge_tracking_branch_symbol:='MT'}      
    : ${omg_should_push_symbol:='SP'}
